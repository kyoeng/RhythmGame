...
public class RhythmGame extends JFrame {
    ...
    private final Image INTRO_BACKGROUND = new ImageIcon(Objects.requireNonNull(Main.class.getResource(IMAGE_ROOT + "introBackground.jpg"))).getImage();
    ...
    public void screenDraw(Graphics g) {
        g.drawImage(INTRO_BACKGROUND, 0, 0, null);               // 0, 0 위치에 이미지 그리기
        paintComponents(g);
