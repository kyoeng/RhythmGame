...
public class RhythmGame extends JFrame {
    ...
    private Image selectedImage = new ImageIcon(Objects.requireNonNull(Main.class.getResource(IMAGE_ROOT + "mightyStartImage.jpg"))).getImage();
    ...
    private final ImageIcon rightBtnBasic = new ImageIcon(Objects.requireNonNull(Main.class.getResource(IMAGE_ROOT + "rightButtonEntered.png")));
    private final ImageIcon rightBtnEntered = new ImageIcon(Objects.requireNonNull(Main.class.getResource(IMAGE_ROOT + "rightButtonBasic.png")));

    // 곡 제목 이미지
    private Image titleImage = new ImageIcon(Objects.requireNonNull(Main.class.getResource(IMAGE_ROOT + "mightyTitle.png"))).getImage();
    ...
    public RhythmGame() {
        ...
        leftBtn.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseEntered(MouseEvent e) {
                leftBtn.setIcon(leftBtnEntered);
                leftBtn.setCursor(new Cursor(Cursor.HAND_CURSOR));
            }

            @Override
            public void mouseExited(MouseEvent e) {
                leftBtn.setIcon(leftBtnBasic);
        ...
        rightBtn.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseEntered(MouseEvent e) {
                rightBtn.setIcon(rightBtnEntered);
            ...
            @Override
            public void mouseExited(MouseEvent e) {
                rightBtn.setIcon(rightBtnBasic);
