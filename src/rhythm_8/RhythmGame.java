...
public class RhythmGame extends JFrame {
    ...
    public RhythmGame() {
        ...
        trackList.add(new Track("mightyTitle.png", "mightyStartImage.png", "mightyGameImage.jpg", "mightySelected.mp3", "joakim-mighty_love.mp3"));
        trackList.add(new Track("wildTitle.png", "flowerStartImage.png", "flowerGameImage.jpg", "wildSelected.mp3", "joakim-wild_flower.mp3"));
        trackList.add(new Track("energyTitle.png", "energyStartImage.png", "energyGameImage.jpg", "energySelected.mp3", "bensound-energy.mp3"));
        ...
        easyBtn.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseEntered(MouseEvent e) {
                easyBtn.setIcon(easyBtnEntered);
        ...
        hardBtn.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseEntered(MouseEvent e) {
                hardBtn.setIcon(hardBtnEntered);
